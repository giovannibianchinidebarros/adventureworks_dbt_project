...
SELECT
    SAFE_CAST(JSON_VALUE(json_data, '$.productid') AS INT64) AS pk_product_id,
    ...
    JSON_VALUE(json_data, '$.sizeunitmeasurecode') AS fk_size_unit_measure_code,
    JSON_VALUE(json_data, '$.weightunitmeasurecode') AS fk_weight_unit_measure_code,
    ...
    SAFE_CAST(JSON_VALUE(json_data, '$.productsubcategoryid') AS INT64) AS fk_product_subcategory_id,
