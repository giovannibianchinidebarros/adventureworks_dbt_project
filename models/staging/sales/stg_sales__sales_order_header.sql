...
SELECT
    SAFE_CAST(JSON_VALUE(json_data, '$.salesorderid') AS INT64) AS pk_sales_order_id,
    ...
    SAFE_CAST(JSON_VALUE(json_data, '$.customerid') AS INT64) AS fk_customer_id,
    SAFE_CAST(JSON_VALUE(json_data, '$.salespersonid') AS INT64) AS fk_salesperson_id,
    SAFE_CAST(JSON_VALUE(json_data, '$.territoryid') AS INT64) AS fk_territory_id,
    SAFE_CAST(JSON_VALUE(json_data, '$.billtoaddressid') AS INT64) AS fk_bill_to_address_id,
    SAFE_CAST(JSON_VALUE(json_data, '$.shiptoaddressid') AS INT64) AS fk_ship_to_address_id,
    ...
    SAFE_CAST(JSON_VALUE(json_data, '$.currencyrateid') AS INT64) AS fk_currency_rate_id,
