...
SELECT
    SAFE_CAST(JSON_VALUE(json_data, '$.purchaseorderid') AS INT64) AS fk_purchase_order_id,
    SAFE_CAST(JSON_VALUE(json_data, '$.purchaseorderdetailid') AS INT64) AS pk_purchase_order_detail_id,
